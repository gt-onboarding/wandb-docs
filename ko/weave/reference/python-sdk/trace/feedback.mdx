---
title: "feedback"
description: "weave.trace.feedback에 대한 Python SDK 참조"
---
...
서버에서 피드백을 지연 로딩 방식으로 가져오는 객체입니다. 
...
유틸리티 기능을 함께 제공하는 Feedback 객체 컬렉션입니다. 
...
특정 ref에 연결된 피드백을 처리하기 위한 객체입니다. 
...
feedback&#95;type: 피드백 유형을 식별하는 문자열입니다. &quot;wandb.&quot; 접두사는 예약되어 있습니다. creator: 피드백 작성자를 표시할 이름입니다.
