...
ScoreLogger는 단일 예측에 대한 점수 산출을 관리합니다.
...
EvaluationLogger에서 완료되지 않은 예측을 감지하기 위해 사용됩니다.
...
이 예측 결과에 대한 점수를 기록합니다.
predict_and_score의 자식으로 scorer 호출을 생성합니다.
...
| 이름 | 타입 | 설명 |
| :------ | :------ | :------ |
| `scorerName` | `string` | 스코어러의 이름 (예: "accuracy", "f1_score") |
| `score` | `any` | 점수 값 |
