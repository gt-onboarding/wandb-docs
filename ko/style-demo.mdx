---
title: "스타일 가이드 데모"
description: "맞춤형 W&B 브랜드 스타일 시연"
---
...
이 페이지는 W&B 문서를 위해 구현된 브랜드 맞춤 스타일을 보여줍니다.
...
본문은 다양한 플랫폼에서 최적의 가독성을 제공하기 위해 시스템 폰트 스택을 사용합니다.
...
링크는 일관성을 위해 <a href="#">teal 계열 색상</a>을 사용합니다.
...
<div className="help-banner custom-banner">
  <h2>도움말 및 지원 배너</h2>
  <p>이 배너는 텍스트 그림자가 적용된 지원 배경 이미지를 사용합니다.</p>
</div>

<div className="card-banner custom-banner">
  <h3>카드 배너</h3>
  <p>정보성 콘텐츠를 위한 은은한 회색 배경 배너입니다.</p>
</div>

<div className="gradient-banner custom-banner">
  <h3>그라디언트 배너</h3>
  <p>눈에 띄는 공지용으로 선셋 그라디언트를 사용합니다.</p>
</div>
...
<div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2rem'}}>
  ...
  <button className="primary-button">프라이머리 버튼</button>
...
<div className="hero-gradient">
  ...
  <p>히어로 섹션과 중요한 공지에 sunset 그라디언트를 사용합니다.</p>
</div>

<div className="card-gradient">
  <h3>은은한 그라디언트가 적용된 카드</h3>
  <p>카드 컴포넌트에 은은한 그라디언트 오버레이를 적용해, 과하지 않게 시각적 흥미를 더합니다.</p>
</div>
...
- 색상은 유지 관리가 쉽도록 CSS 변수로 정의됩니다
- 그라디언트는 브랜드 컬러를 일관되게 사용합니다
- 호버 효과로 상호작용 피드백을 제공합니다