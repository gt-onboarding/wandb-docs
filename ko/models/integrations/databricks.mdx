...
W&B는 Databricks 환경에서 W&B Jupyter 노트북 사용 환경을 맞춤 구성하여 [Databricks](https://www.databricks.com/)와 통합할 수 있습니다.
...
2. 인증 설정
    ...
    노트북에서 조회할 수 있는 Databricks secret을 추가하여 W&B 계정을 인증할 수 있습니다.
...
노트북에서 wandb.sweep() 또는 wandb.agent()를 사용할 때 필요한 임시 설정:
