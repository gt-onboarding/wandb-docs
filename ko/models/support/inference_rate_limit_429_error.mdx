---
title: 왜 W&B Inference에서 요청 제한(429) 오류가 발생하나요?
---

요청 제한 오류(429)는 동시 요청 한도를 초과했을 때 발생합니다.
...
- 병렬 요청 수를 줄입니다
- 요청 사이에 지연 시간을 추가합니다
- 지수 백오프(exponential backoff) 전략을 구현합니다
...
한도를 조정하려면 담당 영업 대표 또는 지원팀에 문의하세요.