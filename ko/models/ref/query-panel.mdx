...
description: W&B에서 데이터를 선택하고 집계하기 위한 베타 버전의 쿼리 언어
---
...
<Tip>
  대화형 예제를 보려면 [Query Panel](https://wandb.ai/luis_team_test/weave_example_queries/reports/Weave-queries---Vmlldzo1NzIxOTY2?access) W&amp;B Report를 확인하세요.
</Tip>
