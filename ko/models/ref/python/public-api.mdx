---
title: Public API 개요
description: W&B Public API를 사용해 프로그래밍 방식으로 W&B 데이터에 접근하고 관리하세요
...
| Component | 설명 |
|-----------|-------------|
| [`Api`](/ko/models/ref/python/public-api/api/) | Public API의 주요 진입 지점입니다. 조직 전체의 실행, 프로젝트, 아티팩트를 조회합니다. |
| [`Runs`](/ko/models/ref/python/public-api/runs/) | 개별 학습 실행에 액세스하고 history, 로그, 메트릭을 관리합니다. |
...
| [`Reports`](/ko/models/reports/create-a-report/) | 프로그래밍 방식으로 W&amp;B Reports를 조회하고 관리합니다. |
...
| [`Integrations`](/ko/models/integrations) | 서드파티 통합을 구성하고 관리합니다. |
