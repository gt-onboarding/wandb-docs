...
예시:
컬렉션 &quot;my-collection&quot;에 새 아티팩트가 생성될 때 발생하는 이벤트를 정의합니다:
...
* `filter` (Union[And, Or, Nor, Not, Lt, Gt, Lte, Gte, Eq, Ne, In, NotIn, Exists, Regex, Contains, FilterExpr, Dict[str, Any]]): 이 이벤트가 발생하기 위해 추가로 필요한 조건이 있다면 지정합니다.
