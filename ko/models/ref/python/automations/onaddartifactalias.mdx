...
새 alias가 아티팩트에 지정됩니다.

예시:
alias &quot;prod&quot;가 컬렉션 &quot;my-collection&quot; 내의 어떤 아티팩트에든
지정될 때마다 발생하는 이벤트를 정의합니다:
...
* `filter` (Union[And, Or, Nor, Not, Lt, Gt, Lte, Gte, Eq, Ne, In, NotIn, Exists, Regex, Contains, FilterExpr, Dict[str, Any]]): 이 이벤트가 트리거되기 위해 필요한 추가 조건(있다면)입니다.
