...
실행 상태 변경에 따라 이벤트를 발생시키기 위한 필터를 나타냅니다.
...
* `run` (Union[And, Or, Nor, Not, Lt, Gt, Lte, Gte, Eq, Ne, In, NotIn, Exists, Regex, Contains, FilterExpr, Dict[str, Any]]): 이 이벤트를 트리거할 실행과 일치해야 하는 필터입니다.
